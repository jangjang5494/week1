...
('CHEONGYAK_PRIVATE_1ST', '분양주택', '민간분양', '민영주택1순위', '청약홈', '수도권', '민간분양 (아파트) — 일반공급 1순위',
 ...
 '{"homeless_required":true,"household_head_required":true,"savings_min_rank1":24,"deposit_min_won":3000000,"notes":["★투기과열지구(서울): 세대주 필수 + 2년이상·24회이상 납입","예치금 기준: 85㎡이하 300만원/102㎡이하 600만원/135㎡이하 1,000만원/모든면적 1,500만원","1순위 제한자(2순위로 처리): 세대주 아닌 자·5년내 당첨이력 세대원·2주택이상소유 세대원","가점제: 85㎡이하 서울 100% 가점제 (무주택기간32점+부양가족35점+가입기간17점=최대84점)","추첨제 시 무주택세대 75% 우선 배정","지역우선: 서울2년거주자 우선, 기타수도권(경기·인천) 차순위"]}',
